defmodule Procore.Connection do
  @moduledoc """
  ...
  - `access_token`: Sets the Bearer token for authentication.
  """
  @type options :: [
          {:base_url, String.t()},
          {:user_agent, String.t()},
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:procore_sdk, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - Procore 1.0 - elixir"
        )
      )

    access_token_middleware =
      case Keyword.get(options, :access_token) do
        nil -> []
        access_token -> [{Tesla.Middleware.BearerAuth, token: access_token}]
      end
    ...
    [
      ...
      | access_token_middleware ++ middleware
    ]
  end
