...
defmodule Procore.Api.CoreWorkflowsWorkflowResponsesProject do
  @moduledoc """
  API calls for all endpoints tagged `CoreWorkflowsWorkflowResponsesProject`.
  """
  ...
  """
  @spec rest_v20_companies_company_id_projects_project_id_workflows_instances_id_responses_post(
          Tesla.Env.client(),
          integer(),
          String.t(),
          String.t(),
          ...
          | {:error, Tesla.Env.t()}
  def rest_v20_companies_company_id_projects_project_id_workflows_instances_id_responses_post(
        connection,
        procore_company_id,
        project_id,
        company_id,
    ...
    request =
      ...
      |> method(:post)
      |> url(
        "/rest/v2.0/companies/#{company_id}/projects/#{project_id}/workflows/instances/#{id}/responses"
      )
