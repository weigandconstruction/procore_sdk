...
defmodule Procore.Api.ConstructionFinancialsCommitmentsRequisitionsSubcontractorInvoices do
  ...
  @spec rest_v10_requisitions_id_patch(
          ...
          | {:error, Tesla.Env.t()}
  def rest_v10_requisitions_id_patch(connection, procore_company_id, id, body22, _opts \\ []) do
    request =
      %{}
      |> method(:patch)
      |> url("/rest/v1.0/requisitions/#{id}")
  ...
  @spec rest_v10_requisitions_post(
          ...
          | {:ok, Procore.Model.RestV11RequisitionsGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_requisitions_post(connection, procore_company_id, body22, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/rest/v1.0/requisitions")
  ...
  @spec rest_v11_requisitions_id_patch(
          ...
          | {:ok, Procore.Model.RestV11RequisitionsGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v11_requisitions_id_patch(connection, procore_company_id, id, body21, opts \\ []) do
    optional_params = %{
      :view => :query
    }
  ...
  @spec rest_v11_requisitions_post(
          ...
          | {:ok, Procore.Model.RestV11RequisitionsGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v11_requisitions_post(connection, procore_company_id, body20, opts \\ []) do
    optional_params = %{
      :view => :query,
      :invite_id => :query
    }
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v20_companies_company_id_projects_project_id_requisitions_id_payment_details_patch(
          Tesla.Env.client(),
          integer(),
          String.t(),
          String.t(),
          String.t(),
          Procore.Model.PaymentDueDate.t(),
          keyword()
        ) ::
          {:ok,
           Procore.Model.RestV20CompaniesCompanyIdProjectsProjectIdRequisitionsIdPaymentDetailsPatch200Response.t()}
  ...
  def rest_v20_companies_company_id_projects_project_id_requisitions_id_payment_details_patch(
    ...
    request =
      ...
      |> method(:patch)
      |> url(
        "/rest/v2.0/companies/#{company_id}/projects/#{project_id}/requisitions/#{id}/payment_details"
      )
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> add_param(:body, :body, payment_due_date)
      |> Enum.into([])
    ...
    |> evaluate_response([
      {200,
       Procore.Model.RestV20CompaniesCompanyIdProjectsProjectIdRequisitionsIdPaymentDetailsPatch200Response},
