...
defmodule Procore.Api.QualitySafetyPunchListPunchListAssigneeOptions do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_punch_list_assignee_options_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
          ...
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_punch_list_assignee_options_get(
        connection,
        procore_company_id,
        project_id,
        opts \\ []
    ...
    request =
      %{}
      |> method(:get)
      |> url("/rest/v1.0/projects/#{project_id}/punch_list_assignee_options")
