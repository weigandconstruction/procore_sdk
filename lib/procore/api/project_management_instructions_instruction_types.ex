...
defmodule Procore.Api.ProjectManagementInstructionsInstructionTypes do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_instruction_types_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
  ...
  def rest_v10_projects_project_id_instruction_types_get(
    ...
    |> evaluate_response([
      {200, Procore.Model.RestV10ProjectsProjectIdInstructionsGet200ResponseInnerInstructionType},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_instruction_types_id_delete(
          Tesla.Env.client(),
          integer(),
          integer(),
          integer(),
          ...
          | {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_instruction_types_id_delete(
        connection,
        procore_company_id,
        project_id,
        id,
  ...
  - `{:ok, Procore.Model.RestV10ProjectsProjectIdInstructionsGet200ResponseInnerInstructionType.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_instruction_types_id_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          integer(),
          ...
          | {:ok,
             Procore.Model.RestV10ProjectsProjectIdInstructionsGet200ResponseInnerInstructionType.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_instruction_types_id_get(
        connection,
        procore_company_id,
        project_id,
        id,
  ...
  @spec rest_v10_projects_project_id_instruction_types_id_patch(
          ...
          | {:ok,
             Procore.Model.RestV10ProjectsProjectIdInstructionsGet200ResponseInnerInstructionType.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_instruction_types_id_patch(
        connection,
        procore_company_id,
        project_id,
        id,
  ...
  @spec rest_v10_projects_project_id_instruction_types_post(
          ...
          | {:ok,
             Procore.Model.RestV10ProjectsProjectIdInstructionsGet200ResponseInnerInstructionType.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_instruction_types_post(
        connection,
        procore_company_id,
        project_id,
        body76,
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, Procore.Model.RestV10ProjectsProjectIdInstructionsGet200ResponseInnerInstructionType},
      {403, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {422, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {:default, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response}
    ])
