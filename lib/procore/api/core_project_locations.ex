...
defmodule Procore.Api.CoreProjectLocations do
  ...
  @spec rest_v10_locations_id_patch(
          ...
          | {:ok, Procore.Model.Location1.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_locations_id_patch(connection, procore_company_id, id, body71, _opts \\ []) do
    request =
      %{}
      |> method(:patch)
      |> url("/rest/v1.0/locations/#{id}")
  ...
  @spec rest_v10_locations_post(
          ...
          | {:ok, Procore.Model.Location1.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_locations_post(connection, procore_company_id, body70, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/rest/v1.0/locations")
