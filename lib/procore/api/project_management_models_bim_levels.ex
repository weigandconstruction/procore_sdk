...
defmodule Procore.Api.ProjectManagementModelsBIMLevels do
  ...
  @spec rest_v10_bim_levels_get(Tesla.Env.client(), integer(), integer(), keyword()) ::
          ...
          | {:ok, list(Procore.Model.RestV10BimLevelsGet200ResponseInner.t())}
          | {:error, Tesla.Env.t()}
  ...
  @spec rest_v10_bim_levels_id_patch(
          ...
          | {:ok, Procore.Model.RestV10BimLevelsGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_bim_levels_id_patch(connection, procore_company_id, id, body132, _opts \\ []) do
    request =
      %{}
      |> method(:patch)
      |> url("/rest/v1.0/bim_levels/#{id}")
  ...
  @spec rest_v10_bim_levels_post(
          ...
          | {:ok, Procore.Model.RestV10BimLevelsGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_bim_levels_post(connection, procore_company_id, body131, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/rest/v1.0/bim_levels")
