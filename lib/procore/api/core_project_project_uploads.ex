...
defmodule Procore.Api.CoreProjectProjectUploads do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_uploads_post(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
  ...
  def rest_v10_projects_project_id_uploads_post(
    ...
    request =
      %{}
      |> method(:post)
      |> url("/rest/v1.0/projects/#{project_id}/uploads")
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_uploads_uuid_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          String.t(),
  ...
  def rest_v10_projects_project_id_uploads_uuid_get(
    ...
    request =
      %{}
      |> method(:get)
      |> url("/rest/v1.0/projects/#{project_id}/uploads/#{uuid}")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> Enum.into([])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_uploads_uuid_patch(
          Tesla.Env.client(),
          integer(),
          integer(),
          String.t(),
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v11_projects_project_id_uploads_post(
          Tesla.Env.client(),
          integer(),
          integer(),
          String.t(),
  ...
  def rest_v11_projects_project_id_uploads_post(
    ...
    request =
      %{}
      |> method(:post)
      |> url("/rest/v1.1/projects/#{project_id}/uploads")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v11_projects_project_id_uploads_uuid_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          String.t(),
  ...
  def rest_v11_projects_project_id_uploads_uuid_get(
    ...
    request =
      %{}
      |> method(:get)
      |> url("/rest/v1.1/projects/#{project_id}/uploads/#{uuid}")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> Enum.into([])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v11_projects_project_id_uploads_uuid_patch(
          Tesla.Env.client(),
          integer(),
          integer(),
          String.t(),
