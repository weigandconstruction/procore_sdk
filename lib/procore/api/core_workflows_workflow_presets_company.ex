...
defmodule Procore.Api.CoreWorkflowsWorkflowPresetsCompany do
  @moduledoc """
  ...
  """
  @spec rest_v20_companies_company_id_workflows_presets_get(
          Tesla.Env.client(),
          integer(),
          String.t(),
          String.t(),
          ...
          | {:error, Tesla.Env.t()}
  def rest_v20_companies_company_id_workflows_presets_get(
        connection,
        procore_company_id,
        company_id,
    ...
    request =
      %{}
      |> method(:get)
      |> url("/rest/v2.0/companies/#{company_id}/workflows/presets")
  ...
  @spec rest_v20_companies_company_id_workflows_presets_id_assignees_patch(
          ...
          | {:error, Tesla.Env.t()}
  def rest_v20_companies_company_id_workflows_presets_id_assignees_patch(
        connection,
        procore_company_id,
        company_id,
        id,
    ...
    request =
      %{}
      |> method(:patch)
      |> url("/rest/v2.0/companies/#{company_id}/workflows/presets/#{id}/assignees")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> add_optional_params(optional_params, opts)
      |> ensure_body()
      |> Enum.into([])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v20_companies_company_id_workflows_presets_id_get(
          Tesla.Env.client(),
          integer(),
          String.t(),
          String.t(),
          ...
          | {:ok, Procore.Model.RestV20CompaniesCompanyIdWorkflowsToolsGet401Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v20_companies_company_id_workflows_presets_id_get(
        connection,
        procore_company_id,
        company_id,
        id,
    ...
    request =
      %{}
      |> method(:get)
      |> url("/rest/v2.0/companies/#{company_id}/workflows/presets/#{id}")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> Enum.into([])
