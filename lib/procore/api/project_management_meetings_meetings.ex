...
defmodule Procore.Api.ProjectManagementMeetingsMeetings do
  ...
  @spec rest_v10_meetings_id_patch(
          ...
          | {:ok, Procore.Model.RestV10MeetingsPost201Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_meetings_id_patch(connection, procore_company_id, id, body65, _opts \\ []) do
    request =
      %{}
      |> method(:patch)
      |> url("/rest/v1.0/meetings/#{id}")
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_meetings_post(Tesla.Env.client(), integer(), Procore.Model.Body64.t(), keyword()) ::
          {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:ok, Procore.Model.RestV10MeetingsPost201Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_meetings_post(connection, procore_company_id, body64, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/rest/v1.0/meetings")
  ...
  @spec rest_v20_companies_company_id_projects_project_id_meetings_id_categories_category_id_delete(
          ...
          | {:error, Tesla.Env.t()}
  def rest_v20_companies_company_id_projects_project_id_meetings_id_categories_category_id_delete(
        connection,
        procore_company_id,
        company_id,
        project_id,
    ...
    request =
      ...
      |> method(:delete)
      |> url(
        "/rest/v2.0/companies/#{company_id}/projects/#{project_id}/meetings/#{id}/categories/#{category_id}"
      )
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> Enum.into([])
