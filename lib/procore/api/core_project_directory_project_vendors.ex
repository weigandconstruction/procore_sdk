...
defmodule Procore.Api.CoreProjectDirectoryProjectVendors do
  ...
  @spec rest_v10_projects_project_id_vendors_get(
          ...
          | {:ok, list(Procore.Model.RestV11ProjectsProjectIdVendorsGet200ResponseInnerOneOf.t())}
          | {:error, Tesla.Env.t()}
  ...
  @spec rest_v11_projects_project_id_vendors_get(
          ...
          {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:ok, list(Procore.Model.RestV11ProjectsProjectIdVendorsGet200ResponseInner.t())}
          | {:error, Tesla.Env.t()}
