...
defmodule Procore.Api.ProjectManagementProjectScheduleRequestedChanges do
  @moduledoc """
  ...
  """
  @spec rest_v10_requested_changes_get(Tesla.Env.client(), integer(), integer(), keyword()) ::
          {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:ok, Procore.Model.RestV10RequestedChangesGet200Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_requested_changes_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, Procore.Model.RestV10RequestedChangesGet200Response},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_requested_changes_post(
          Tesla.Env.client(),
          integer(),
          integer(),
          integer(),
          ...
          | {:error, Tesla.Env.t()}
  def rest_v10_requested_changes_post(
        connection,
        procore_company_id,
        project_id,
        task_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_requested_changes_review_patch(
          Tesla.Env.client(),
          integer(),
          integer(),
