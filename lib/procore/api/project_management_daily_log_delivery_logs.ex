...
defmodule Procore.Api.ProjectManagementDailyLogDeliveryLogs do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_delivery_logs_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
          ...
          | {:ok, list(Procore.Model.RestV10ProjectsProjectIdDeliveryLogsGet200ResponseInner.t())}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_delivery_logs_get(
    ...
    |> evaluate_response([
      {200, Procore.Model.RestV10ProjectsProjectIdDeliveryLogsGet200ResponseInner},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_delivery_logs_id_delete(
          Tesla.Env.client(),
          integer(),
          integer(),
          integer(),
  ...
  - `{:ok, Procore.Model.RestV10ProjectsProjectIdDeliveryLogsGet200ResponseInner.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_delivery_logs_id_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          integer(),
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_delivery_logs_id_patch(
          Tesla.Env.client(),
          integer(),
          integer(),
          integer(),
          Procore.Model.RestV10ProjectsProjectIdDeliveryLogsIdPatchRequest.t(),
          keyword()
        ) ::
          {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:ok, Procore.Model.RestV10ProjectsProjectIdDeliveryLogsGet200ResponseInner.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_delivery_logs_post(
          Tesla.Env.client(),
          integer(),
          integer(),
          Procore.Model.RestV10ProjectsProjectIdDeliveryLogsPostRequest.t(),
          keyword()
        ) ::
          {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:ok, Procore.Model.RestV10ProjectsProjectIdDeliveryLogsGet200ResponseInner.t()}
  ...
  def rest_v10_projects_project_id_delivery_logs_post(
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, Procore.Model.RestV10ProjectsProjectIdDeliveryLogsGet200ResponseInner},
      {400, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {403, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response}
    ])
  end
