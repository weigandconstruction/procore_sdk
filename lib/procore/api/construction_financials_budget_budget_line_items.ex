...
defmodule Procore.Api.ConstructionFinancialsBudgetBudgetLineItems do
  ...
  @spec rest_v10_budget_line_items_post(
          ...
          | {:ok, Procore.Model.RestV10BudgetLineItemsPost422Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_budget_line_items_post(connection, procore_company_id, body122, _opts \\ []) do
    request =
      %{}
      |> method(:post)
  ...
  @spec rest_v10_budget_line_items_sync_post(
          ...
          | {:ok, Procore.Model.RestV10BudgetLineItemsPost422Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_budget_line_items_sync_post(connection, procore_company_id, body124, _opts \\ []) do
    request =
      %{}
      |> method(:post)
  ...
  @spec rest_v11_budget_line_items_post(
          ...
          | {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v11_budget_line_items_post(connection, procore_company_id, body120, _opts \\ []) do
    request =
      %{}
      |> method(:post)
