...
defmodule Procore.Api.CorePortfolioProjects do
  ...
  @spec rest_v10_projects_id_logo_post(
          ...
          | {:ok, Procore.Model.Project3.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_id_logo_post(connection, procore_company_id, id, body33, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/rest/v1.0/projects/#{id}/logo")
  ...
  @spec rest_v10_projects_id_patch(
          ...
          | {:ok, Procore.Model.Project3.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_id_patch(connection, procore_company_id, id, body32, opts \\ []) do
    optional_params = %{
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_post(Tesla.Env.client(), integer(), Procore.Model.Body31.t(), keyword()) ::
          {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:ok, Procore.Model.Project3.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_post(connection, procore_company_id, body31, opts \\ []) do
    optional_params = %{
      :run_configurable_validations => :query
    }
