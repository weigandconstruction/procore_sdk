...
defmodule Procore.Api.ConstructionFinancialsCommitmentsRequisitionSubcontractorInvoiceChangeOrderItems do
  @moduledoc """
  ...
  Return a list of Requisition (Subcontractor Invoice) Change Order Items  See [Filtering on List Actions](https://developers.procore.com/documentation/filtering-on-list-actions) for information on using the filtering capabilities provided by this endpoint.
  ...
  """
  @spec rest_v10_requisitions_requisition_id_change_order_items_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          integer(),
          ...
          | {:ok,
             [
               Procore.Model.RestV10RequisitionsRequisitionIdChangeOrderItemsGet200ResponseInner.t()
             ]}
          | {:error, Tesla.Env.t()}
  def rest_v10_requisitions_requisition_id_change_order_items_get(
        connection,
        procore_company_id,
        requisition_id,
        project_id,
    ...
    |> evaluate_response([
      {200, Procore.Model.RestV10RequisitionsRequisitionIdChangeOrderItemsGet200ResponseInner},
  ...
  @spec rest_v10_requisitions_requisition_id_change_order_items_id_get(
          ...
          | {:ok,
             Procore.Model.RestV10RequisitionsRequisitionIdChangeOrderItemsGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_requisitions_requisition_id_change_order_items_id_get(
        connection,
        procore_company_id,
        requisition_id,
        id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_requisitions_requisition_id_change_order_items_id_patch(
          Tesla.Env.client(),
          integer(),
          integer(),
          integer(),
          ...
          | {:ok,
             Procore.Model.RestV10RequisitionsRequisitionIdChangeOrderItemsGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_requisitions_requisition_id_change_order_items_id_patch(
        connection,
        procore_company_id,
        requisition_id,
        id,
