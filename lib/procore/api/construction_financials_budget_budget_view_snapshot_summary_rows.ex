...
defmodule Procore.Api.ConstructionFinancialsBudgetBudgetViewSnapshotSummaryRows do
  @moduledoc """
  ...
  - `opts` (keyword): Optional parameters
    ...
    - `:budget_row_type` (String.t): Return budgeted, unbudgeted or all item(s) from all budget rows for a project. Default is all. Note that when the unbudgeted or all values are supplied, the subtotals may change depending on the presence of rows that have budgeted false

  ### Returns

  - `{:ok, [%RestV10BudgetViewSnapshotsBudgetViewSnapshotIdSummaryRowsGet200ResponseInner{}, ...]}` on success
  ...
  def rest_v10_budget_view_snapshots_budget_view_snapshot_id_summary_rows_get(
    ...
    request =
      %{}
      |> method(:get)
      |> url("/rest/v1.0/budget_view_snapshots/#{budget_view_snapshot_id}/summary_rows")
    ...
    |> evaluate_response([
      {200,
       Procore.Model.RestV10BudgetViewSnapshotsBudgetViewSnapshotIdSummaryRowsGet200ResponseInner},
