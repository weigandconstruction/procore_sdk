...
defmodule Procore.Api.ConstructionFinancialsPrimeContractsPrimeContracts do
  @moduledoc """
  ...
  @spec rest_v10_prime_contract_id_patch(
          ...
          | {:ok, Procore.Model.RestV10PrimeContractGet200Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_prime_contract_id_patch(connection, procore_company_id, id, body45, opts \\ []) do
    optional_params = %{
  ...
  @spec rest_v10_prime_contract_post(
          ...
          | {:ok, Procore.Model.RestV10PrimeContractGet200Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_prime_contract_post(connection, procore_company_id, body45, opts \\ []) do
    optional_params = %{
      :run_configurable_validations => :query
    }
