...
defmodule Procore.Api.ConstructionFinancialsUnitsOfMeasureUnitsOfMeasure do
  ...
  - `{:ok, Procore.Model.RestV20CompaniesCompanyIdUomsConfigurationGet200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v20_companies_company_id_uoms_configuration_get(
          Tesla.Env.client(),
          integer(),
          String.t(),
          keyword()
          ...
          | {:error, Tesla.Env.t()}
  def rest_v20_companies_company_id_uoms_configuration_get(
        connection,
        procore_company_id,
        company_id,
        _opts \\ []
    ...
    request =
      %{}
      |> method(:get)
      |> url("/rest/v2.0/companies/#{company_id}/uoms/configuration")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> Enum.into([])
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, Procore.Model.RestV20CompaniesCompanyIdUomsConfigurationGet200Response},
