...
defmodule Procore.Api.QualitySafetyObservationsObservations do
  ...
  @spec rest_v10_observations_items_post(
          Tesla.Env.client(),
          integer(),
          Procore.Model.Body55.t(),
          keyword()
        ) ::
          {:ok, Procore.Model.ObservationItem1.t()}
          | {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_observations_items_post(connection, procore_company_id, body55, opts \\ []) do
    optional_params = %{
      :run_configurable_validations => :query
    }
  ...
  Returns a collection of available statuses.
  ...
  @spec rest_v10_projects_project_id_observations_items_statuses_get(
          ...
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_observations_items_statuses_get(
        connection,
        procore_company_id,
        project_id,
        _opts \\ []
    ...
    request =
      %{}
      |> method(:get)
      |> url("/rest/v1.0/projects/#{project_id}/observations/items/statuses")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> Enum.into([])
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, Procore.Model.ArrayOfAvailableStatusesInner},
      {400, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {401, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {403, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response}
    ])
