...
defmodule Procore.Api.ProjectManagementDailyLogInspectionLogs do
  @moduledoc """
  ...
  - `{:ok, [%RestV10ProjectsProjectIdInspectionLogsGet200ResponseInner{}, ...]}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_inspection_logs_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
  ...
  def rest_v10_projects_project_id_inspection_logs_get(
    ...
    request =
      %{}
      |> method(:get)
      |> url("/rest/v1.0/projects/#{project_id}/inspection_logs")
    ...
    |> evaluate_response([
      {200, Procore.Model.RestV10ProjectsProjectIdInspectionLogsGet200ResponseInner},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_inspection_logs_id_delete(
          Tesla.Env.client(),
          integer(),
          integer(),
          integer(),
          ...
          | {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_inspection_logs_id_delete(
        connection,
        procore_company_id,
        project_id,
        id,
    ...
    request =
      %{}
      |> method(:delete)
      |> url("/rest/v1.0/projects/#{project_id}/inspection_logs/#{id}")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> Enum.into([])
  ...
  - `{:ok, Procore.Model.RestV10ProjectsProjectIdInspectionLogsGet200ResponseInner.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_inspection_logs_id_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          integer(),
          ...
          | {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_inspection_logs_id_get(
        connection,
        procore_company_id,
        project_id,
        id,
  ...
  - `project_id` (integer()): Unique identifier for the project.
  - `id` (integer()): Inspection Log ID
  - `rest_v10_projects_project_id_inspection_logs_id_patch_request` (RestV10ProjectsProjectIdInspectionLogsIdPatchRequest): 
  - `opts` (keyword): Optional parameters
  ...
  @spec rest_v10_projects_project_id_inspection_logs_id_patch(
          ...
          integer(),
          integer(),
          Procore.Model.RestV10ProjectsProjectIdInspectionLogsIdPatchRequest.t(),
          keyword()
        ) ::
          {:ok, Procore.Model.RestV10ProjectsProjectIdInspectionLogsGet200ResponseInner.t()}
          | {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_inspection_logs_id_patch(
        connection,
        procore_company_id,
        project_id,
        id,
        rest_v10_projects_project_id_inspection_logs_id_patch_request,
        _opts \\ []
      ) do
    request =
      %{}
      ...
      |> url("/rest/v1.0/projects/#{project_id}/inspection_logs/#{id}")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> add_param(:body, :body, rest_v10_projects_project_id_inspection_logs_id_patch_request)
      |> Enum.into([])
  ...
  - `procore_company_id` (integer()): Unique company identifier associated with the Procore User Account.
  - `project_id` (integer()): Unique identifier for the project.
  - `rest_v10_projects_project_id_inspection_logs_post_request` (RestV10ProjectsProjectIdInspectionLogsPostRequest): 
  - `opts` (keyword): Optional parameters
  ...
  @spec rest_v10_projects_project_id_inspection_logs_post(
          ...
          integer(),
          integer(),
          Procore.Model.RestV10ProjectsProjectIdInspectionLogsPostRequest.t(),
          keyword()
        ) ::
          {:ok, Procore.Model.RestV10ProjectsProjectIdInspectionLogsGet200ResponseInner.t()}
          | {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_inspection_logs_post(
        connection,
        procore_company_id,
        project_id,
        rest_v10_projects_project_id_inspection_logs_post_request,
        _opts \\ []
      ) do
    request =
      %{}
      ...
      |> url("/rest/v1.0/projects/#{project_id}/inspection_logs")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> add_param(:body, :body, rest_v10_projects_project_id_inspection_logs_post_request)
      |> Enum.into([])

    connection
    |> Connection.request(request)
    |> evaluate_response([
      {201, Procore.Model.RestV10ProjectsProjectIdInspectionLogsGet200ResponseInner},
      {400, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {403, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {422, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response}
    ])
