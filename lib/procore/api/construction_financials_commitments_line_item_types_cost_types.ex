...
defmodule Procore.Api.ConstructionFinancialsCommitmentsLineItemTypesCostTypes do
  ...
  def rest_v10_line_item_types_get(
    ...
    |> evaluate_response([
      {200, Procore.Model.LineItemType2},
  ...
  @spec rest_v10_line_item_types_id_patch(
          ...
          | {:ok, Procore.Model.LineItemType2.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_line_item_types_id_patch(connection, procore_company_id, id, body74, _opts \\ []) do
    request =
      %{}
      |> method(:patch)
      |> url("/rest/v1.0/line_item_types/#{id}")
  ...
  @spec rest_v10_line_item_types_post(
          ...
          | {:ok, Procore.Model.LineItemType2.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_line_item_types_post(connection, procore_company_id, body74, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/rest/v1.0/line_item_types")
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, Procore.Model.LineItemType2},
      {400, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {401, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {403, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {:default, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response}
