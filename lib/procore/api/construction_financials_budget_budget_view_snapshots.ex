...
defmodule Procore.Api.ConstructionFinancialsBudgetBudgetViewSnapshots do
  ...
  def rest_v10_budget_view_snapshots_get(connection, procore_company_id, project_id, opts \\ []) do
    optional_params = %{
      :page => :query,
      :per_page => :query,
      :"filters[budget_template_id]" => :query,
      :"filters[budget_view_id]" => :query,
      :"filters[snapshot_type]" => :query,
      :"filters[approval_status]" => :query,
      :sort => :query
    }
  ...
  Create a new Budget View Snapshot for the Project and Budget. This is rate limited to one request per hour for each Project and Budget View pair.
