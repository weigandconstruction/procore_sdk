...
defmodule Procore.Api.ConstructionFinancialsCommitmentsRequisitionSubcontractorInvoiceContractDetailItems do
  @moduledoc """
  ...
  def rest_v10_requisitions_requisition_id_contract_detail_items_get(
    ...
    |> evaluate_response([
      {200, Procore.Model.RestV10RequisitionsRequisitionIdContractDetailItemsGet200ResponseInner},
  ...
  - `{:ok, Procore.Model.RestV10RequisitionsRequisitionIdContractDetailItemsGet200ResponseInner.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_requisitions_requisition_id_contract_detail_items_id_get(
          ...
          | {:ok,
             Procore.Model.RestV10WorkOrderContractsWorkOrderContractIdSubcontractorScheduleOfValuesStatusPatch404Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_requisitions_requisition_id_contract_detail_items_id_get(
        connection,
        procore_company_id,
        requisition_id,
        id,
  ...
  @spec rest_v10_requisitions_requisition_id_contract_detail_items_id_patch(
          ...
          | {:ok,
             Procore.Model.RestV10WorkOrderContractsWorkOrderContractIdSubcontractorScheduleOfValuesStatusPatch404Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_requisitions_requisition_id_contract_detail_items_id_patch(
        connection,
        procore_company_id,
        requisition_id,
        id,
