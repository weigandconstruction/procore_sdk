...
defmodule Procore.Api.ProjectManagementDailyLogVisitorLogs do
  @moduledoc """
  ...
  @spec rest_v10_projects_project_id_visitor_logs_get(
          ...
          | {:ok, list(Procore.Model.RestV10ProjectsProjectIdVisitorLogsGet200ResponseInner.t())}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_visitor_logs_get(
        connection,
        procore_company_id,
        project_id,
        opts \\ []
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_visitor_logs_id_delete(
          Tesla.Env.client(),
          integer(),
          integer(),
          integer(),
          ...
          | {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_visitor_logs_id_delete(
        connection,
        procore_company_id,
        project_id,
        id,
  ...
  - `{:ok, Procore.Model.RestV10ProjectsProjectIdVisitorLogsGet200ResponseInner.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_visitor_logs_id_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          integer(),
          ...
          {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:ok, Procore.Model.RestV10ProjectsProjectIdVisitorLogsGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_visitor_logs_id_get(
        connection,
        procore_company_id,
        project_id,
        id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_visitor_logs_id_patch(
          Tesla.Env.client(),
          integer(),
          integer(),
          integer(),
          Procore.Model.RestV10ProjectsProjectIdVisitorLogsIdPatchRequest.t(),
          keyword()
        ) ::
          {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:ok, Procore.Model.RestV10ProjectsProjectIdVisitorLogsGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_visitor_logs_id_patch(
        connection,
        procore_company_id,
        project_id,
        id,
        rest_v10_projects_project_id_visitor_logs_id_patch_request,
        opts \\ []
      ) do
    optional_params = %{
  ...
  @spec rest_v10_projects_project_id_visitor_logs_post(
          ...
          integer(),
          integer(),
          Procore.Model.RestV10ProjectsProjectIdVisitorLogsPostRequest.t(),
          keyword()
        ) ::
          {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:ok, Procore.Model.RestV10ProjectsProjectIdVisitorLogsGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_visitor_logs_post(
        connection,
        procore_company_id,
        project_id,
        rest_v10_projects_project_id_visitor_logs_post_request,
        opts \\ []
      ) do
    optional_params = %{
      :run_configurable_validations => :query
