...
defmodule Procore.Api.CoreCompanyDirectoryCompanyUsers do
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v20_companies_company_id_users_bulk_remove_project_details_patch(
          Tesla.Env.client(),
          integer(),
          String.t(),
          Procore.Model.CompanyUserBodyBulkUpdateProjectDetails.t(),
          keyword()
        ) ::
          {:ok,
           Procore.Model.RestV20CompaniesCompanyIdUsersBulkRemoveProjectDetailsPatch200Response.t()}
          | {:ok, Procore.Model.RestV20CompaniesCompanyIdWorkflowsToolsGet401Response.t()}
          | {:ok,
             Procore.Model.RestV20CompaniesCompanyIdUsersBulkRemoveProjectDetailsPatch207Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v20_companies_company_id_users_bulk_remove_project_details_patch(
        connection,
        procore_company_id,
        company_id,
        company_user_body_bulk_update_project_details,
        _opts \\ []
      ) do
    request =
      %{}
      |> method(:patch)
      |> url("/rest/v2.0/companies/#{company_id}/users/bulk_remove_project_details")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> add_param(:body, :body, company_user_body_bulk_update_project_details)
      |> Enum.into([])

    connection
    |> Connection.request(request)
    |> evaluate_response([
      {200, Procore.Model.RestV20CompaniesCompanyIdUsersBulkRemoveProjectDetailsPatch200Response},
      {207, Procore.Model.RestV20CompaniesCompanyIdUsersBulkRemoveProjectDetailsPatch207Response},
  ...
  This endpoint allows company users to bulk update their project details on multiple projects
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v20_companies_company_id_users_bulk_update_project_details_patch(
          Tesla.Env.client(),
          integer(),
          String.t(),
          Procore.Model.CompanyUserBodyBulkUpdateProjectDetails.t(),
          ...
          {:ok,
           Procore.Model.RestV20CompaniesCompanyIdUsersBulkUpdateProjectDetailsPatch200Response.t()}
          | {:ok, Procore.Model.RestV20CompaniesCompanyIdWorkflowsToolsGet401Response.t()}
          | {:ok,
             Procore.Model.RestV20CompaniesCompanyIdUsersBulkUpdateProjectDetailsPatch207Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v20_companies_company_id_users_bulk_update_project_details_patch(
        connection,
        procore_company_id,
        company_id,
        company_user_body_bulk_update_project_details,
    ...
    request =
      %{}
      |> method(:patch)
      |> url("/rest/v2.0/companies/#{company_id}/users/bulk_update_project_details")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> add_param(:body, :body, company_user_body_bulk_update_project_details)
      |> Enum.into([])
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, Procore.Model.RestV20CompaniesCompanyIdUsersBulkUpdateProjectDetailsPatch200Response},
      {207, Procore.Model.RestV20CompaniesCompanyIdUsersBulkUpdateProjectDetailsPatch207Response},
      {400, Procore.Model.RestV20CompaniesCompanyIdWorkflowsToolsGet401Response},
      {401, Procore.Model.RestV20CompaniesCompanyIdWorkflowsToolsGet401Response},
      {403, Procore.Model.RestV20CompaniesCompanyIdWorkflowsToolsGet401Response}
    ])
