...
defmodule Procore.Api.ConstructionFinancialsBudgetBudgetViewDetailRows do
  @moduledoc """
  ...
  """
  @spec rest_v10_budget_views_budget_view_id_detail_rows_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          integer(),
          ...
          | {:error, Tesla.Env.t()}
  def rest_v10_budget_views_budget_view_id_detail_rows_get(
        connection,
        procore_company_id,
        budget_view_id,
        project_id,
