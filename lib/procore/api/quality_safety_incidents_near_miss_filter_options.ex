...
defmodule Procore.Api.QualitySafetyIncidentsNearMissFilterOptions do
  @moduledoc """
  ...
  def rest_v10_projects_project_id_incidents_near_misses_filter_options_affected_companies_get(
    ...
    request =
      ...
      |> method(:get)
      |> url(
        "/rest/v1.0/projects/#{project_id}/incidents/near_misses/filter_options/affected_companies"
      )
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_incidents_near_misses_filter_options_affected_parties_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
  ...
  def rest_v10_projects_project_id_incidents_near_misses_filter_options_affected_parties_get(
    ...
    request =
      ...
      |> method(:get)
      |> url(
        "/rest/v1.0/projects/#{project_id}/incidents/near_misses/filter_options/affected_parties"
      )
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> Enum.into([])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_incidents_near_misses_filter_options_affected_persons_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
  ...
  def rest_v10_projects_project_id_incidents_near_misses_filter_options_affected_persons_get(
    ...
    request =
      ...
      |> method(:get)
      |> url(
        "/rest/v1.0/projects/#{project_id}/incidents/near_misses/filter_options/affected_persons"
      )
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> Enum.into([])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_incidents_near_misses_filter_options_harm_sources_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
  ...
  def rest_v10_projects_project_id_incidents_near_misses_filter_options_harm_sources_get(
    ...
    request =
      ...
      |> method(:get)
      |> url(
        "/rest/v1.0/projects/#{project_id}/incidents/near_misses/filter_options/harm_sources"
      )
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> Enum.into([])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_incidents_near_misses_filter_options_managed_equipment_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
  ...
  def rest_v10_projects_project_id_incidents_near_misses_filter_options_managed_equipment_get(
    ...
    request =
      ...
      |> method(:get)
      |> url(
        "/rest/v1.0/projects/#{project_id}/incidents/near_misses/filter_options/managed_equipment"
      )
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> Enum.into([])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_incidents_near_misses_filter_options_work_activities_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
  ...
  def rest_v10_projects_project_id_incidents_near_misses_filter_options_work_activities_get(
    ...
    request =
      ...
      |> method(:get)
      |> url(
        "/rest/v1.0/projects/#{project_id}/incidents/near_misses/filter_options/work_activities"
      )
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> Enum.into([])
