...
defmodule Procore.Api.CoreCompanyCompanyOffices do
  ...
  @spec rest_v10_offices_id_patch(
          ...
          | {:ok, Procore.Model.Office1.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_offices_id_patch(connection, procore_company_id, id, body113, _opts \\ []) do
    request =
      %{}
      |> method(:patch)
      |> url("/rest/v1.0/offices/#{id}")
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_offices_post(Tesla.Env.client(), integer(), Procore.Model.Body113.t(), keyword()) ::
          {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:ok, Procore.Model.Office1.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_offices_post(connection, procore_company_id, body113, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/rest/v1.0/offices")
