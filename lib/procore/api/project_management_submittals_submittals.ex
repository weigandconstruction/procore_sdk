...
defmodule Procore.Api.ProjectManagementSubmittalsSubmittals do
  ...
  @spec rest_v10_projects_project_id_submittals_filter_options_ball_in_court_company_id_get(
          ...
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_submittals_filter_options_ball_in_court_company_id_get(
        connection,
        procore_company_id,
        project_id,
        opts \\ []
    ...
    request =
      ...
      |> method(:get)
      |> url(
        "/rest/v1.0/projects/#{project_id}/submittals/filter_options/ball_in_court_company_id"
      )
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
    ...
    |> evaluate_response([
      {200,
       Procore.Model.RestV10ProjectsProjectIdSubmittalsFilterOptionsBallInCourtCompanyIdGet200ResponseInner},
      {401, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {403, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_submittals_filter_options_number_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
          ...
          | {:ok,
             [
               Procore.Model.RestV10ProjectsProjectIdSubmittalsFilterOptionsNumberGet200ResponseInner.t()
             ]}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_submittals_filter_options_number_get(
        connection,
        procore_company_id,
        project_id,
        opts \\ []
    ...
    request =
      %{}
      |> method(:get)
      |> url("/rest/v1.0/projects/#{project_id}/submittals/filter_options/number")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
    ...
    |> evaluate_response([
      {200,
       Procore.Model.RestV10ProjectsProjectIdSubmittalsFilterOptionsNumberGet200ResponseInner},
      {401, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {403, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response}
    ])
  end
  ...
  @spec rest_v10_projects_project_id_submittals_filter_options_submittal_workflow_template_id_get(
          ...
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_submittals_filter_options_submittal_workflow_template_id_get(
        connection,
        procore_company_id,
        project_id,
        opts \\ []
    ...
    request =
      ...
      |> method(:get)
      |> url(
        "/rest/v1.0/projects/#{project_id}/submittals/filter_options/submittal_workflow_template_id"
      )
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
    ...
    |> evaluate_response([
      {200,
       Procore.Model.RestV10ProjectsProjectIdSubmittalsFilterOptionsSubmittalWorkflowTemplateIdGet200ResponseInner},
      {401, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {403, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response}
    ])
  end
  ...
  - `opts` (keyword): Optional parameters
    ...
    - `:"filters[number]"` ([String.t]): Array of Numbers. A single Number is also accepted.
    - `:sort` (String.t): 
