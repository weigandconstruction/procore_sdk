...
defmodule Procore.Api.QualitySafetyObservationsCompanyObservationTypes do
  @moduledoc """
  ...
  - `{:ok, [%CompanyObservationType{}, ...]}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_companies_company_id_observation_types_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
  ...
  def rest_v10_companies_company_id_observation_types_get(
    ...
    |> evaluate_response([
      {200, Procore.Model.CompanyObservationType},
