...
defmodule Procore.Api.FieldProductivityTimesheetTimesheets do
  ...
  - `procore_company_id` (integer()): Unique company identifier associated with the Procore User Account.
  - `project_id` (integer()): Unique identifier for the project.
  - `timesheets_signature_create_body1` (TimesheetsSignatureCreateBody1): 
  - `opts` (keyword): Optional parameters
  ...
  @spec rest_v10_projects_project_id_timesheets_signatures_post(
          ...
          integer(),
          integer(),
          Procore.Model.TimesheetsSignatureCreateBody1.t(),
          keyword()
        ) ::
          {:ok, Procore.Model.TimesheetsSignature.t()}
          | {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
  ...
  def rest_v10_projects_project_id_timesheets_signatures_post(
        ...
        procore_company_id,
        project_id,
        timesheets_signature_create_body1,
        _opts \\ []
      ) do
    request =
      %{}
      ...
      |> url("/rest/v1.0/projects/#{project_id}/timesheets/signatures")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> add_param(:body, :body, timesheets_signature_create_body1)
      |> Enum.into([])
  ...
  - `project_id` (integer()): Unique identifier for the project.
  - `opts` (keyword): Optional parameters
    - `:body` (RestV11ProjectsProjectIdProjectTimecardEntriesBulkCreatePostRequest): 

  ### Returns

  - `{:ok, [%TimecardEntry{}, ...]}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v11_projects_project_id_project_timecard_entries_bulk_create_post(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
        ) :: {:ok, [Procore.Model.TimecardEntry.t()]} | {:error, Tesla.Env.t()}
  def rest_v11_projects_project_id_project_timecard_entries_bulk_create_post(
        connection,
        procore_company_id,
        project_id,
        opts \\ []
    ...
    request =
      %{}
      |> method(:post)
      |> url("/rest/v1.1/projects/#{project_id}/project_timecard_entries/bulk_create")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> add_optional_params(optional_params, opts)
      |> ensure_body()
      |> Enum.into([])
