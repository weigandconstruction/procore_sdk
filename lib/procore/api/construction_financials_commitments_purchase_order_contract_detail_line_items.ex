...
defmodule Procore.Api.ConstructionFinancialsCommitmentsPurchaseOrderContractDetailLineItems do
  @moduledoc """
  ...
  @spec rest_v10_purchase_order_contracts_purchase_order_contract_id_line_item_contract_details_get(
          ...
          | {:error, Tesla.Env.t()}
  def rest_v10_purchase_order_contracts_purchase_order_contract_id_line_item_contract_details_get(
        connection,
        procore_company_id,
    ...
    request =
      ...
      |> method(:get)
      |> url(
        "/rest/v1.0/purchase_order_contracts/#{purchase_order_contract_id}/line_item_contract_details"
      )
  ...
  @spec rest_v10_purchase_order_contracts_purchase_order_contract_id_line_item_contract_details_id_delete(
          ...
          | {:ok,
             Procore.Model.RestV10WorkOrderContractsWorkOrderContractIdSubcontractorScheduleOfValuesStatusPatch404Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_purchase_order_contracts_purchase_order_contract_id_line_item_contract_details_id_delete(
        connection,
        procore_company_id,
        purchase_order_contract_id,
        id,
    ...
    request =
      ...
      |> method(:delete)
      |> url(
        "/rest/v1.0/purchase_order_contracts/#{purchase_order_contract_id}/line_item_contract_details/#{id}"
      )
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> add_param(:query, :project_id, project_id)
      |> Enum.into([])
  ...
  @spec rest_v10_purchase_order_contracts_purchase_order_contract_id_line_item_contract_details_id_get(
          ...
          | {:ok,
             Procore.Model.RestV10WorkOrderContractsWorkOrderContractIdSubcontractorScheduleOfValuesStatusPatch404Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_purchase_order_contracts_purchase_order_contract_id_line_item_contract_details_id_get(
        connection,
        procore_company_id,
        purchase_order_contract_id,
        id,
  ...
  @spec rest_v10_purchase_order_contracts_purchase_order_contract_id_line_item_contract_details_id_patch(
          ...
          | {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_purchase_order_contracts_purchase_order_contract_id_line_item_contract_details_id_patch(
        connection,
        procore_company_id,
        purchase_order_contract_id,
        id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_purchase_order_contracts_purchase_order_contract_id_line_item_contract_details_post(
          Tesla.Env.client(),
          integer(),
          integer(),
          Procore.Model.Body4.t(),
          ...
          | {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_purchase_order_contracts_purchase_order_contract_id_line_item_contract_details_post(
        connection,
        procore_company_id,
        purchase_order_contract_id,
        body4,
