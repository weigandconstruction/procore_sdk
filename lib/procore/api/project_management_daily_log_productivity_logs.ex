...
defmodule Procore.Api.ProjectManagementDailyLogProductivityLogs do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_productivity_logs_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
          ...
          | {:ok,
             list(Procore.Model.RestV10ProjectsProjectIdProductivityLogsGet200ResponseInner.t())}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_productivity_logs_get(
        connection,
        procore_company_id,
        project_id,
        opts \\ []
    ...
    |> evaluate_response([
      {200, Procore.Model.RestV10ProjectsProjectIdProductivityLogsGet200ResponseInner},
  ...
  @spec rest_v10_projects_project_id_productivity_logs_id_delete(
          ...
          | {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_productivity_logs_id_delete(
        connection,
        procore_company_id,
        project_id,
        id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_productivity_logs_id_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          integer(),
          ...
          {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:ok, Procore.Model.RestV10ProjectsProjectIdProductivityLogsGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_productivity_logs_id_get(
        connection,
        procore_company_id,
        project_id,
        id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_productivity_logs_id_patch(
          Tesla.Env.client(),
          integer(),
          integer(),
          integer(),
          Procore.Model.RestV10ProjectsProjectIdProductivityLogsIdPatchRequest.t(),
          keyword()
        ) ::
          {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:ok, Procore.Model.RestV10ProjectsProjectIdProductivityLogsGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_productivity_logs_id_patch(
        connection,
        procore_company_id,
        project_id,
        id,
        rest_v10_projects_project_id_productivity_logs_id_patch_request,
        _opts \\ []
      ) do
    request =
      %{}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_productivity_logs_post(
          Tesla.Env.client(),
          integer(),
          integer(),
          Procore.Model.RestV10ProjectsProjectIdProductivityLogsPostRequest.t(),
          keyword()
        ) ::
          {:ok, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t()}
          | {:ok, Procore.Model.RestV10ProjectsProjectIdProductivityLogsGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_productivity_logs_post(
        connection,
        procore_company_id,
        project_id,
        rest_v10_projects_project_id_productivity_logs_post_request,
        _opts \\ []
      ) do
    request =
      %{}
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, Procore.Model.RestV10ProjectsProjectIdProductivityLogsGet200ResponseInner},
      {400, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {403, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response}
    ])
  end
