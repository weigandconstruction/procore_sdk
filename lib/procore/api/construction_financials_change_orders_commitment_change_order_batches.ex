...
defmodule Procore.Api.ConstructionFinancialsChangeOrdersCommitmentChangeOrderBatches do
  @moduledoc """
  API calls for all endpoints tagged `ConstructionFinancialsChangeOrdersCommitmentChangeOrderBatches`.
  """
  ...
  def rest_v10_projects_project_id_commitment_change_order_batches_get(
    ...
    request =
      %{}
      |> method(:get)
      |> url("/rest/v1.0/projects/#{project_id}/commitment_change_order_batches")
    ...
    |> evaluate_response([
      {200, Procore.Model.RestV10ProjectsProjectIdCommitmentChangeOrderBatchesGet200Response},
  ...
  def rest_v10_projects_project_id_commitment_change_order_batches_id_delete(
    ...
    request =
      %{}
      |> method(:delete)
      |> url("/rest/v1.0/projects/#{project_id}/commitment_change_order_batches/#{id}")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> Enum.into([])
  ...
  def rest_v10_projects_project_id_commitment_change_order_batches_id_get(
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, Procore.Model.RestV10ProjectsProjectIdCommitmentChangeOrderBatchesPost201Response},
      {401, Procore.Model.RestV10ProjectsGetDefaultResponse},
      {403, Procore.Model.RestV10ProjectsGetDefaultResponse},
      {:default, Procore.Model.RestV10ProjectsGetDefaultResponse}
    ])
  ...
  def rest_v10_projects_project_id_commitment_change_order_batches_post(
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, Procore.Model.RestV10ProjectsProjectIdCommitmentChangeOrderBatchesPost201Response},
      {400, Procore.Model.RestV10ProjectsGetDefaultResponse},
      {401, Procore.Model.RestV10ProjectsGetDefaultResponse},
      {403, Procore.Model.RestV10ProjectsGetDefaultResponse},
      {:default, Procore.Model.RestV10ProjectsGetDefaultResponse}
