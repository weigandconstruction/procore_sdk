...
defmodule Procore.Api.ProjectManagementRFIRFIs do
  ...
  - `opts` (keyword): Optional parameters
    ...
    - `:"filters[number]"` (integer()): Return item(s) with the specified RFI Number.
    - `:"filters[prefix_stage_id]"` (String.t): Return item(s) with the specified RFI Prefix Stage.
