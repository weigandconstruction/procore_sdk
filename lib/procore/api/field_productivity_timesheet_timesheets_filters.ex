...
defmodule Procore.Api.FieldProductivityTimesheetTimesheetsFilters do
  ...
  - `{:ok, [%RestV10CompaniesCompanyIdTimesheetsFiltersOfficesGet200ResponseInner{}, ...]}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_companies_company_id_timesheets_filters_offices_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
          ...
          | {:ok,
             [
               Procore.Model.RestV10CompaniesCompanyIdTimesheetsFiltersOfficesGet200ResponseInner.t()
             ]}
          | {:error, Tesla.Env.t()}
  def rest_v10_companies_company_id_timesheets_filters_offices_get(
        connection,
        procore_company_id,
        company_id,
        _opts \\ []
    ...
    request =
      %{}
      |> method(:get)
      |> url("/rest/v1.0/companies/#{company_id}/timesheets/filters/offices")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> Enum.into([])
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, Procore.Model.RestV10CompaniesCompanyIdTimesheetsFiltersOfficesGet200ResponseInner},
      {400, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {403, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {404, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response}
    ])
