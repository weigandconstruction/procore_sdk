...
defmodule Procore.Api.QualitySafetyInspectionsChecklistScheduleFilterOptions do
  ...
  - `{:ok, [%RestV10ProjectsProjectIdChecklistSchedulesFilterOptionsEquipmentGet200ResponseInner{}, ...]}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_checklist_schedules_filter_options_equipment_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
          ...
          | {:ok,
             [
               Procore.Model.RestV10ProjectsProjectIdChecklistSchedulesFilterOptionsEquipmentGet200ResponseInner.t()
             ]}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_checklist_schedules_filter_options_equipment_get(
        connection,
        procore_company_id,
        project_id,
        _opts \\ []
    ...
    request =
      %{}
      |> method(:get)
      |> url("/rest/v1.0/projects/#{project_id}/checklist/schedules/filter_options/equipment")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> Enum.into([])
    ...
    |> evaluate_response([
      {200,
       Procore.Model.RestV10ProjectsProjectIdChecklistSchedulesFilterOptionsEquipmentGet200ResponseInner},
      {401, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response},
      {403, Procore.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response}
    ])
  end
