...
defmodule Procore.Api.ConstructionFinancialsCommitmentsCommitmentContractExportPDF do
  @moduledoc """
  API calls for all endpoints tagged `ConstructionFinancialsCommitmentsCommitmentContractExportPDF`.
  """
  ...
  - `commitment_contract_id` (String.t): Unique identifier for the Commitment Contract.
  ...
  """
  @spec rest_v20_companies_company_id_projects_project_id_commitment_contracts_commitment_contract_id_pdf_get(
          Tesla.Env.client(),
          integer(),
          String.t(),
          String.t(),
          ...
          | {:error, Tesla.Env.t()}
  def rest_v20_companies_company_id_projects_project_id_commitment_contracts_commitment_contract_id_pdf_get(
        connection,
        procore_company_id,
        company_id,
        project_id,
    ...
    request =
      ...
      |> method(:get)
      |> url(
        "/rest/v2.0/companies/#{company_id}/projects/#{project_id}/commitment_contracts/#{commitment_contract_id}/pdf"
      )
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v20_companies_company_id_projects_project_id_commitment_contracts_commitment_contract_id_pdf_post(
          Tesla.Env.client(),
          integer(),
          String.t(),
          String.t(),
          ...
          | {:ok, Procore.Model.RestV20CompaniesCompanyIdWorkflowsToolsGet401Response.t()}
          | {:error, Tesla.Env.t()}
  def rest_v20_companies_company_id_projects_project_id_commitment_contracts_commitment_contract_id_pdf_post(
        connection,
        procore_company_id,
        company_id,
        project_id,
