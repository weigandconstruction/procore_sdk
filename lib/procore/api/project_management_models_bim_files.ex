...
defmodule Procore.Api.ProjectManagementModelsBIMFiles do
  ...
  @spec rest_v10_bim_files_get(Tesla.Env.client(), integer(), integer(), keyword()) ::
          ...
          | {:ok, list(Procore.Model.RestV10BimFilesGet200ResponseInner.t())}
          | {:error, Tesla.Env.t()}
  ...
  @spec rest_v10_bim_files_id_patch(
          ...
          | {:ok, Procore.Model.RestV10BimFilesGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_bim_files_id_patch(connection, procore_company_id, id, body136, _opts \\ []) do
    request =
      %{}
      |> method(:patch)
      |> url("/rest/v1.0/bim_files/#{id}")
  ...
  @spec rest_v10_bim_files_post(
          ...
          | {:ok, Procore.Model.RestV10BimFilesGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_bim_files_post(connection, procore_company_id, body135, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/rest/v1.0/bim_files")
