...
defmodule Procore.Api.CoreProjectDirectoryProjectDirectoryFilterOptions do
  ...
  """
  @spec rest_v10_projects_project_id_directory_filter_options_cost_codes_get(
          Tesla.Env.client(),
          integer(),
          integer(),
          keyword()
          ...
          | {:ok,
             [
               Procore.Model.RestV10ProjectsProjectIdDirectoryFilterOptionsCostCodesGet200ResponseInner.t()
             ]}
          | {:error, Tesla.Env.t()}
  def rest_v10_projects_project_id_directory_filter_options_cost_codes_get(
        connection,
        procore_company_id,
        project_id,
        _opts \\ []
    ...
    request =
      %{}
      |> method(:get)
      |> url("/rest/v1.0/projects/#{project_id}/directory/filter_options/cost_codes")
    ...
    |> evaluate_response([
      {200,
       Procore.Model.RestV10ProjectsProjectIdDirectoryFilterOptionsCostCodesGet200ResponseInner},
