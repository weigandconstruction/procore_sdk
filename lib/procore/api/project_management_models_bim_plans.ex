...
defmodule Procore.Api.ProjectManagementModelsBIMPlans do
  ...
  @spec rest_v10_bim_plans_get(Tesla.Env.client(), integer(), integer(), keyword()) ::
          ...
          | {:ok, list(Procore.Model.RestV10BimPlansGet200ResponseInner.t())}
          | {:error, Tesla.Env.t()}
  ...
  @spec rest_v10_bim_plans_id_patch(
          ...
          | {:ok, Procore.Model.RestV10BimPlansGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_bim_plans_id_patch(connection, procore_company_id, id, body121, _opts \\ []) do
    request =
      %{}
      |> method(:patch)
      |> url("/rest/v1.0/bim_plans/#{id}")
  ...
  @spec rest_v10_bim_plans_post(
          ...
          | {:ok, Procore.Model.RestV10BimPlansGet200ResponseInner.t()}
          | {:error, Tesla.Env.t()}
  def rest_v10_bim_plans_post(connection, procore_company_id, body120, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/rest/v1.0/bim_plans")
