...
defmodule Procore.Api.ConstructionFinancialsWorkBreakdownStructureCodes do
  ...
  - `opts` (keyword): Optional parameters
    ...
    - `:group_type` (String.t): Along with 'group_id', groups WBS codes by the specified group type and group ID. Only supported option is 'contract'.
    - `:group_id` (integer()): Along with 'group_type', groups WBS codes by the specified group type and group ID. Only supported option is a contract ID.
    - `:hide_not_in_group` (boolean()): If true, will hide WBS codes that are not in the specified 'group_type' and 'group_id'. Default is true. If false, WBS codes in the specified group will be returned first followed by WBS codes not in the group.
    - `:page` (integer()): Page
