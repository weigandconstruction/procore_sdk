...
defmodule Procore.Api.CoreProjectProjectDates do
  ...
  @spec rest_v20_companies_company_id_projects_project_id_project_dates_get(
          ...
          {:ok,
           Procore.Model.RestV20CompaniesCompanyIdProjectsProjectIdProjectDatesGet200Response.t()}
  ...
  def rest_v20_companies_company_id_projects_project_id_project_dates_get(
    ...
    request =
      %{}
      |> method(:get)
      |> url("/rest/v2.0/companies/#{company_id}/projects/#{project_id}/project_dates")
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, Procore.Model.RestV20CompaniesCompanyIdProjectsProjectIdProjectDatesGet200Response},
