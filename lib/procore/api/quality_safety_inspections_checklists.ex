...
defmodule Procore.Api.QualitySafetyInspectionsChecklists do
  ...
  @doc """
  Create Checklists (Inspection) in Bulk
  Creates multiple instances of an Inspection in a given Project
  ...
  @spec rest_v20_companies_company_id_projects_project_id_checklist_lists_bulk_create_post(
          ...
          | {:error, Tesla.Env.t()}
  def rest_v20_companies_company_id_projects_project_id_checklist_lists_bulk_create_post(
        connection,
        procore_company_id,
        company_id,
        project_id,
    ...
    request =
      ...
      |> method(:post)
      |> url(
        "/rest/v2.0/companies/#{company_id}/projects/#{project_id}/checklist/lists/bulk_create"
      )
      |> add_param(:headers, :"Procore-Company-Id", procore_company_id)
      |> add_optional_params(optional_params, opts)
      |> ensure_body()
    ...
    |> evaluate_response([
      {200,
       Procore.Model.RestV20CompaniesCompanyIdProjectsProjectIdChecklistListsBulkCreatePost200Response},
