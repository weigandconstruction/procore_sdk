...
defmodule Procore.Model.Body99CoordinationIssue do
  @moduledoc """
  Coordination Issue
  """
  ...
  @type t :: %__MODULE__{
          ...
          :viewpoints => [Procore.Model.Body99CoordinationIssueViewpointsInner.t()] | nil
        }
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :viewpoints,
      :list,
      Procore.Model.Body99CoordinationIssueViewpointsInner
    )
  end
end
