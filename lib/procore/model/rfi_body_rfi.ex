...
defmodule Procore.Model.RfiBodyRfi do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :question => Procore.Model.RfiBodyRfiQuestion.t(),
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:question, :struct, Procore.Model.RfiBodyRfiQuestion)
