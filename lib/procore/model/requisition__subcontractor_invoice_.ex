...
defmodule Procore.Model.RequisitionSubcontractorInvoice do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :items => [Procore.Model.RequisitionSubcontractorInvoiceItemsInner.t()] | nil,
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :items,
      :list,
      Procore.Model.RequisitionSubcontractorInvoiceItemsInner
    )
