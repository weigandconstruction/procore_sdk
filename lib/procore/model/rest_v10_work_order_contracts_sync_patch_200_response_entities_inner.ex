...
defmodule Procore.Model.RestV10WorkOrderContractsSyncPatch200ResponseEntitiesInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :vendor =>
            Procore.Model.RestV10WorkOrderContractsGet200ResponseInnerAllOfVendor.t() | nil,
          :currency_configuration =>
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :vendor,
      :struct,
      Procore.Model.RestV10WorkOrderContractsGet200ResponseInnerAllOfVendor
    )
    |> Deserializer.deserialize(
      :currency_configuration,
      :struct,
