...
defmodule Procore.Model.ChecklistListGroupedData do
  @moduledoc """
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:closed_by, :struct, Procore.Model.PunchItem6CreatedBy)
    |> Deserializer.deserialize(
      :responsible_contractor,
      :struct,
      Procore.Model.ChecklistListGroupedDataResponsibleContractor
    )
    |> Deserializer.deserialize(:point_of_contact, :struct, Procore.Model.PunchItem6CreatedBy)
    |> Deserializer.deserialize(:trade, :struct, Procore.Model.Trade)
    |> Deserializer.deserialize(:inspectors, :list, Procore.Model.PunchItem6CreatedBy)
    |> Deserializer.deserialize(:distribution_members, :list, Procore.Model.PunchItem6CreatedBy)
    |> Deserializer.deserialize(
      :signature_requests,
      :list,
    ...
    |> Deserializer.deserialize(
      :permissions,
      :struct,
      Procore.Model.ChecklistListGroupedDataPermissions
    )
    |> Deserializer.deserialize(
      :custom_fields,
      :struct,
