...
defmodule Procore.Model.Project3 do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :from_project_template_id => integer() | nil,
          ...
          :persistent_message => Procore.Model.ProjectPersistentMessage1.t() | nil,
          :office => Procore.Model.ProjectOffice1.t() | nil,
          ...
          :project_type => Procore.Model.ProjectType2.t() | nil,
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :persistent_message,
      :struct,
      Procore.Model.ProjectPersistentMessage1
    )
    |> Deserializer.deserialize(:office, :struct, Procore.Model.ProjectOffice1)
    ...
    |> Deserializer.deserialize(:project_type, :struct, Procore.Model.ProjectType2)
