...
defmodule Procore.Model.TimesheetEntries2 do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :timecard_time_type => Procore.Model.TimecardTimeType2.t() | nil
        }
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:timecard_time_type, :struct, Procore.Model.TimecardTimeType2)
  end
end
