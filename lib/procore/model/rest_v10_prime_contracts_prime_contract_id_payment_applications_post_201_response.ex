...
defmodule Procore.Model.RestV10PrimeContractsPrimeContractIdPaymentApplicationsPost201Response do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :g703 =>
            [
              Procore.Model.RestV10PrimeContractsPrimeContractIdPaymentApplicationsPost201ResponseAllOfG703Inner.t()
            ]
            | nil,
          :id => integer() | nil,
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :g703,
      :list,
      Procore.Model.RestV10PrimeContractsPrimeContractIdPaymentApplicationsPost201ResponseAllOfG703Inner
    )
