...
defmodule Procore.Model.PunchItem6 do
  @moduledoc """
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:assignments, :list, Procore.Model.PunchItem6AssignmentsInner)
    |> Deserializer.deserialize(:assignees, :list, Procore.Model.PunchItem6CreatedBy)
    |> Deserializer.deserialize(
      :custom_fields,
      :struct,
