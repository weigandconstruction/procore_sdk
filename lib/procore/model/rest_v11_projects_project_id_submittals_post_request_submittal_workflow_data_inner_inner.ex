...
defmodule Procore.Model.RestV11ProjectsProjectIdSubmittalsPostRequestSubmittalWorkflowDataInnerInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :submittal_log_approver_id => integer() | nil
        }
