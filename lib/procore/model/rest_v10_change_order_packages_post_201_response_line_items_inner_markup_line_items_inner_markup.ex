...
defmodule Procore.Model.RestV10ChangeOrderPackagesPost201ResponseLineItemsInnerMarkupLineItemsInnerMarkup do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :destination_cost_code =>
            ...
            | nil,
          :destination_line_item_type => Procore.Model.LineItemType3.t() | nil,
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:destination_line_item_type, :struct, Procore.Model.LineItemType3)
    |> Deserializer.deserialize(
      :destination_sub_job,
      :struct,
