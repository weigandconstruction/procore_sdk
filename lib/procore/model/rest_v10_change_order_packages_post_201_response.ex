...
defmodule Procore.Model.RestV10ChangeOrderPackagesPost201Response do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :attachments =>
            ...
            | nil,
          :line_items =>
            [Procore.Model.RestV10ChangeOrderPackagesPost201ResponseLineItemsInner.t()] | nil,
          :currency_configuration =>
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :line_items,
      :list,
      Procore.Model.RestV10ChangeOrderPackagesPost201ResponseLineItemsInner
    )
    |> Deserializer.deserialize(
      :currency_configuration,
      :struct,
