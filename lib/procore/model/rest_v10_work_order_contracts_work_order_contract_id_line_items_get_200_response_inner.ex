...
defmodule Procore.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsGet200ResponseInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :change_event_line_item =>
            Procore.Model.RestV10WorkOrderContractsPost201ResponseLineItemsInnerChangeEventLineItem.t()
            | nil,
          :currency_configuration =>
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :change_event_line_item,
      :struct,
      Procore.Model.RestV10WorkOrderContractsPost201ResponseLineItemsInnerChangeEventLineItem
    )
    |> Deserializer.deserialize(
      :currency_configuration,
      :struct,
