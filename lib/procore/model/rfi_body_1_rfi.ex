...
defmodule Procore.Model.RfiBody1Rfi do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :question => Procore.Model.RfiBody1RfiQuestion.t(),
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:question, :struct, Procore.Model.RfiBody1RfiQuestion)
