...
defmodule Procore.Model.RestV11ProjectsProjectIdSubmittalsPostRequest1Submittal do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :workflow_data =>
            [
              [
                Procore.Model.RestV11ProjectsProjectIdSubmittalsPostRequest1SubmittalWorkflowDataInnerInner.t()
              ]
            ]
            | nil,
          :"custom_field_%{custom_field_definition_id}" =>
