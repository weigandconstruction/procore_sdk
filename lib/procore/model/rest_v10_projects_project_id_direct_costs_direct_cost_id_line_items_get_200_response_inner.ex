...
defmodule Procore.Model.RestV10ProjectsProjectIdDirectCostsDirectCostIdLineItemsGet200ResponseInner do
  @moduledoc """
  Line Item
  """
  ...
  @type t :: %__MODULE__{
          ...
          :currency_configuration =>
            Procore.Model.RestV10ProjectsProjectIdDirectCostsDirectCostIdLineItemsGet200ResponseInnerCurrencyConfiguration.t()
            | nil
        }
