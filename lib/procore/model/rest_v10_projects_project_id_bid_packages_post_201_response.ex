...
defmodule Procore.Model.RestV10ProjectsProjectIdBidPackagesPost201Response do
  ...
  @type t :: %__MODULE__{
          ...
          :has_any_bid_invited => boolean() | nil,
          :has_any_bids_sent_nda => boolean() | nil,
          :has_no_nda_activity => boolean() | nil,
          ...
          :nda_attachments =>
            [
              Procore.Model.RestV10ProjectsProjectIdBidPackagesPost201ResponseNdaAttachmentsInner.t()
            ]
            | nil,
          :number => integer() | nil,
          :open => boolean() | nil,
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :nda_attachments,
      :list,
      Procore.Model.RestV10ProjectsProjectIdBidPackagesPost201ResponseNdaAttachmentsInner
    )
    |> Deserializer.deserialize(
      :point_of_contact,
      :struct,
