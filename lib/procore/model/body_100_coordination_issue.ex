...
defmodule Procore.Model.Body100CoordinationIssue do
  @moduledoc """
  Coordination Issue
  """
  ...
  @type t :: %__MODULE__{
          ...
          :viewpoints => [Procore.Model.Body100CoordinationIssueViewpointsInner.t()] | nil
        }
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :viewpoints,
      :list,
      Procore.Model.Body100CoordinationIssueViewpointsInner
    )
  end
end
