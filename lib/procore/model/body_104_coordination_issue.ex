...
defmodule Procore.Model.Body104CoordinationIssue do
  @moduledoc """
  Coordination Issue
  """
  ...
  @type t :: %__MODULE__{
          ...
          :origin => Procore.Model.Body104CoordinationIssueOrigin.t() | nil,
          :attachment_upload_uuids => [String.t()] | nil,
          :attachments => [String.t()] | nil,
          :viewpoints => [Procore.Model.Body104CoordinationIssueViewpointsInner.t()] | nil
        }
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:origin, :struct, Procore.Model.Body104CoordinationIssueOrigin)
    |> Deserializer.deserialize(
      :viewpoints,
      :list,
      Procore.Model.Body104CoordinationIssueViewpointsInner
    )
  end
end
