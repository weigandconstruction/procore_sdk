...
defmodule Procore.Model.CompanyVendorSyncBodyUpdatesInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :bidding => Procore.Model.CompanyVendorSyncBodyUpdatesInnerBidding.t() | nil
        }
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :bidding,
      :struct,
      Procore.Model.CompanyVendorSyncBodyUpdatesInnerBidding
    )
  end
end
