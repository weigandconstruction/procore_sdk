...
defmodule Procore.Model.RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :markup_line_items =>
            [
              Procore.Model.RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInnerMarkupLineItemsInner.t()
            ]
            | nil,
          :currency_configuration =>
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :markup_line_items,
      :list,
      Procore.Model.RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInnerMarkupLineItemsInner
    )
    |> Deserializer.deserialize(
      :currency_configuration,
      :struct,
