...
defmodule Procore.Model.ChecklistTemplate4 do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :sections => [Procore.Model.ChecklistTemplate4SectionsInner.t()] | nil
        }
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:sections, :list, Procore.Model.ChecklistTemplate4SectionsInner)
  end
end
